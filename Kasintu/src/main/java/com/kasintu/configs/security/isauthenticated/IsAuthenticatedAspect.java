package com.kasintu.configs.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.kasintu.configs.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
        //SpringBoot already handles the method
    }

    @Pointcut("@within(com.kasintu.configs.security.isauthenticated.IsAuthenticated)")
