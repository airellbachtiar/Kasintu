...
class GetBannerServiceImplTest {

    @Mock
    private BannerRepository bannerRepositoryMock;

    @InjectMocks
    private GetBannerServiceImpl getBannerService;

    @Test
    void getBanner_ReturnBanner()
    {
        ...
        Optional<BannerDTO> bannerOptional = getBannerService.getBanner("1");
        BannerDTO actualResult = bannerOptional.orElseThrow();

        BannerDTO expectedResult = BannerDTO.builder()
                .bannerID("1")
                .cost(100)
                .pullRates(
                        List.of(
